#!/usr/bin/env python3
"""Fetch ALL users from MedBasket API — standalone script."""
...
def main():
    ...
    print("Fetching users from api.medbasket.com ...")
    ...
    # Save JSON
    json_path = os.path.join(OUT_DIR, "users.json")
    ...
    print(f"Done — {len(records):,} users saved.")
